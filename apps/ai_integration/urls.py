...
urlpatterns = [
    ...
    # Mood & Tone Analysis
    path(
        "caption/analyze-mood/",
        views.analyze_mood_and_tone,
        name="analyze_mood_and_tone",
    ),
    # Caption Improvement
    path("caption/improve/", views.improve_caption, name="improve_caption"),
    # Generate Content by Mood
    path(
        "caption/generate-by-mood/",
        views.generate_content_by_mood,
        name="generate_content_by_mood",
    ),
    # Rewrite Caption by Mood/Tone
    path(
        "caption/rewrite-by-mood/",
        views.rewrite_caption_by_mood,
        name="rewrite_caption_by_mood",
    ),
    # Campaign Theme Detection
    path(
        "campaign/detect-theme/",
        views.detect_campaign_theme,
        name="detect_campaign_theme",
    ),
    # =========================================================================
    ...
    path(
        "predict-engagement/",
        views.EngagementPredictionView.as_view(),
        name="predict_engagement",
    ),
    # Get engagement forecast for a specific post
    path(
        "engagement-forecast/<int:post_id>/",
    ...
    path(
        ...
        views.get_optimal_posting_times,
