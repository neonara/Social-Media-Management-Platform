...
from permissions.permissions import IsModeratorOrCM, IsClient, IsModeratorOrCMOrAdmin
...
class SocialPagesView(APIView):
    ...
    def get(self, request):
        ...
        response = {
            ...
            "connected_platforms": {
                "facebook": any(
                    page["platform"] == "facebook" for page in serializer.data
                ),
                "instagram": any(
                    page["platform"] == "instagram" for page in serializer.data
                ),
                "linkedin": any(
                    page["platform"] == "linkedin" for page in serializer.data
                ),
            },
        }
...
class ClientSocialPagesView(APIView):
    """
    Get all social media pages connected to a specific client (for moderators, community managers, and super admins)
    """
