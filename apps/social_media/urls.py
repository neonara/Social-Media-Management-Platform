...
urlpatterns = [
    path('social/facebook/<int:post_id>/publish/', publish_to_facebook, name='publish_facebook'),
    path('social/instagram/<int:post_id>/publish/', publish_to_instagram, name='publish_instagram'),
    path('social/linkedin/<int:post_id>/publish/', publish_to_linkedin, name='publish_linkedin'),
