...
from .views import (
    FacebookConnectView, FacebookCallbackView, FacebookDisconnectView, PublishToFacebookView,
    InstagramConnectView, InstagramCallbackView, InstagramDisconnectView, PublishToInstagramView,
    LinkedInConnectView, LinkedInCallbackView, LinkedInDisconnectView, PublishToLinkedInView, FacebookPageView, InstagramPageView, LinkedInPageView
)

urlpatterns = [
    path('facebook/<int:post_id>/publish/', PublishToFacebookView.as_view(), name='publish_facebook'),
    path('instagram/<int:post_id>/publish/', PublishToInstagramView.as_view(), name='publish_instagram'),
    path('linkedin/<int:post_id>/publish/', PublishToLinkedInView.as_view(), name='publish_linkedin'),
    ...
    path('instagram/disconnect/', InstagramDisconnectView.as_view(), name='ig_disconnect'),
    ...
    path('linkedin/disconnect/', LinkedInDisconnectView.as_view(), name='linkedin_disconnect'),
    ...
    path('social/pages/client/<int:client_id>/', ClientSocialPagesView.as_view(), name='client_social_pages'),
