...
class Post(models.Model):
    ...
    feedback_at = models.DateTimeField(
        null=True, blank=True, help_text="When the feedback was provided"
    )
    client_approved_at = models.DateTimeField(
        null=True, blank=True, help_text="When the client approved this post"
    )
    client_rejected_at = models.DateTimeField(
        null=True, blank=True, help_text="When the client rejected this post"
    )
    moderator_validated_at = models.DateTimeField(
        null=True, blank=True, help_text="When the moderator validated this post"
    )
    moderator_rejected_at = models.DateTimeField(
        null=True, blank=True, help_text="When the moderator rejected this post"
    )
    published_at = models.DateTimeField(
        null=True, blank=True, help_text="When the post was actually published"
    )
    ...
    is_moderator_validated = models.BooleanField(
        null=True, blank=True, help_text="Whether the moderator has validated this post"
    )
...
# Import PostAnalytics to ensure Django recognizes the reverse relation
from .analytics_models import PostAnalytics  # noqa: E402, F401
