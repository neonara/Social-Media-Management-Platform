...
class PostSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if hashtags:
            ...
            validated_data[
                "description"
            ] = f"{validated_data.get('description', '').strip()}\n\n{hashtag_string}"
        validated_data["creator"] = self.context[
            "request"
        ].user  # creator houwa l logged user
    ...
    def update(self, instance, validated_data):
        ...
        if hashtags:
            ...
            validated_data[
                "description"
            ] = f"{validated_data.get('description', instance.description).strip()}\n\n{hashtag_string}"

        # win lupdate
        instance.title = validated_data.get("title", instance.title)
        instance.description = validated_data.get("description", instance.description)
        instance.scheduled_for = validated_data.get(
