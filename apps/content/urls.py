...
from .views import (
    UpdatePostToDraftView,
    GetPostCreatorsView,
    FetchCMClientPostsView,
    SaveDraftView,
    CreatePostView,
    ListPostsView,
    UpdatePostView,
    ...
    ApprovePostView,
    RejectPostView,
    FetchPendingPostsView,
    PostFeedbackView,
    GetPostByIdView,
    PublishPostView,
    ResubmitPostView,
    CancelApprovalView,
    ModeratorValidatePostView,
)
from .reports_views import GenerateReportView
...
urlpatterns = [
    ...
    path(
        "posts/client/<int:client_id>/create/",
        CreatePostView.as_view(),
        name="create-post-for-client",
    ),
    ...
    path(
        "posts/<int:post_id>/approve/", ApprovePostView.as_view(), name="approve-post"
    ),
    path(
        "posts/<int:post_id>/validate/",
        ModeratorValidatePostView.as_view(),
        name="validate-post",
    ),
    path("posts/<int:post_id>/reject/", RejectPostView.as_view(), name="reject-post"),
    path(
        "posts/<int:post_id>/publish/", PublishPostView.as_view(), name="publish-post"
    ),
    path(
        "posts/<int:post_id>/resubmit/",
        ResubmitPostView.as_view(),
        name="resubmit-post",
    ),
    path(
        "posts/<int:post_id>/cancel-approval/",
        CancelApprovalView.as_view(),
        name="cancel-approval",
    ),
    path(
        "posts/<int:post_id>/feedback/",
        PostFeedbackView.as_view(),
        name="post-feedback",
    ),
    ...
    path(
        "posts/cm/clients/",
        FetchCMClientPostsView.as_view(),
        name="fetch-cm-client-posts",
    ),
    path(
        "posts/<int:post_id>/to-draft/",
        UpdatePostToDraftView.as_view(),
        name="update-post-to-draft",
    ),
    # Media
